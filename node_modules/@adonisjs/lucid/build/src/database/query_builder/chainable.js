 ...
 * different API.
 */
export class Chainable extends Macroable {
    knexQuery;
    queryCallback;
    keysResolver;
    hasAggregates = false;
     ...
     */
    withRecursive(alias, query, columns = []) {
        if (columns.length > 0) {
     ...
     */
    withMaterialized(alias, query, columns = []) {
        if (columns.length > 0) {
     ...
     */
    withNotMaterialized(alias, query, columns = []) {
        if (columns.length > 0) {
