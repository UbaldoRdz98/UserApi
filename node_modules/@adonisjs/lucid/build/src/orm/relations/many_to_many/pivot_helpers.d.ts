...
export declare class PivotHelpers {
     ...
     */
    wherePivot(varition: 'or' | 'and' | 'not' | 'orNot', key: any, operator?: any, value?: any): ManyToManySubQueryBuilder | ManyToManyQueryBuilder;
    /**
     * Adds a where pivot condition to the query
     */
     ...
     * Adds a where pivot condition to the query
     */
    whereInPivot(varition: 'or' | 'and' | 'not' | 'orNot', key: any, value: any): ManyToManySubQueryBuilder | ManyToManyQueryBuilder;
    /**
